...
As you can see, middleware functions have access to Express's [request object](https://expressjs.com/en/api.html#req) (`req`) and [response object](https://expressjs.com/en/api.html#res) (`res`) objects.
