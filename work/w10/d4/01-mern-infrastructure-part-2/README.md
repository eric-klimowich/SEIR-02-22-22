...
- Check out React Router's [`useParams`](https://reactrouter.com/docs/en/v6/api#useparams) hook that allows you to access route parameters similar to how we did in Express.

### Other Topics

- Use React Router's [`<NavLink>`](https://reactrouter.com/docs/en/v6/api#navlink) component when you want to style hyperlinks dynamically based upon the current URL.
