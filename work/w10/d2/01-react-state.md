...
<details><summary>❓ What line of code could you use to define state to track whose turn it is in a Tic-Tac-Toe app?</summary>
<p>

```jsx
const [turn, setTurn] = useState(1); // 1 represents player 1; -1 is player 2 
```
...
<details><summary>❓ What state would be used to compute <code>winner</code>?</summary>
<p><code>board</code></p>
</details>
