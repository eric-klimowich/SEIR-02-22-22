...
# Welcome to General Assembly SEIR-2-22-22!!!!
...
- Course Dates: Tuesday, February 22nd, 2022 - Monday, May 16th, 2022 (60 days)
- Holidays: N/A

### Link to the Class Zoom Room

[Link to join the class Zoom Room](https://generalassembly.zoom.us/j/99001914191?pwd=b3FsNzkvNnhLUENHWUxWei8vZjNFZz09)
...
|:--         | :--             | :--         | :-- |
|Lead Instructor | Michael Siller | @Michael Siller - LA | michael.siller@generalassemb.ly |
|Lead Instructor | Eric Klimowich | @Eric Klimowich | eric.klimowich@generalassemb.ly |
|Instructional Associate | Victor Luo | @Victor Luo | victor.luo@generalassemb.ly |
|Instructional Associate | Julio Leon | @Julio Leon | julio.leon@generalassemb.ly |

### Link to Recorded Lessons

For your convenience, links to the recordings of the lessons will be maintained in the `zoom-recordings` slack channel.
...
In the case of multi-part labs, each part will count as one deliverable, however, all parts will be submitted due on a single due date. 
...
Please click [this invite link](https://classroom.google.com/c/NDczMTQwMjM1OTM1?cjc=hpwg4vm) to join the Google Classroom!
...
2. In another tab, browse to the GA class repo:  [https://git.generalassemb.ly/msiller455/SEIR-02-22-22](https://git.generalassemb.ly/msiller455/SEIR-02-22-22)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/SEIR-02-22-22.git
```

You can now `$ cd SEIR-02-22-22` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/msiller455/SEIR-02-22-22.git
```
